...
def train(
    ...
    for _ in range(epochs):
        net, loss, noise_var = _training_loop(net, trainloader, device, criterion, optimizer)
...
def _training_loop(
    ...
    for features, targets in trainloader:
        ...
        loss.mean().backward()
        optimizer.step()
    return net, sum_loss/len(trainloader.dataset), trainloader.dataset.mean_noise_var
...
def val(
    ...
    return loss, valloader.dataset.mean_noise_var